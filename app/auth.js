...
module.exports = {
	...
	'cleverAuthDev' : {
		...
		'callbackURL' 	: encodeURIComponent('https://bell-schedule-app-maayanyavne.herokuapp.com/auth/clever/callback'),//encodeURIComponent('https://128.12.160.33:8080/auth/clever/callback'),
